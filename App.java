...
public class App {
    ...
    static void CargarPeliculas(ArrayList<Pelicula> peliculas) {
        File ficheer = new File("c:\\Users\\Miguel Campo\\Desktop\\aplicacion-cine-main\\fichero.txt"); //indicamos el path de donde el se cogera la informacion del fichero txt
        Scanner sc = null;
